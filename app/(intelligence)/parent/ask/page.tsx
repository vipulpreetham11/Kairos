...
import { askParentAI } from './actions'
...
const SUGGESTIONS = [
  ...
  'Is attendance okay this month?',
  'Which subject needs the most attention?',
  'What was studied this week?',
  'How did my child perform in the last exam?',
]
...
export default function ParentAskPage() {
  ...
  async function handleSubmit(question: string) {
    ...
    const response = await askParentAI(trimmed, conversationHistory)
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex-shrink-0">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Ask About My Child</h1>
          <p className="text-sm text-slate-500 mt-0.5">
            Ask anything about your child's attendance, results, and homework
          </p>
        </div>
      </div>
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full px-4 py-12">
            ...
            <p className="text-sm text-slate-500 max-w-sm text-center">
              Get personalized insights about your child's progress, homework, and attendance instantly.
            </p>
        ...
        <div className="flex gap-3 items-end">
          <div className="flex-1">
            <textarea
              ...
              placeholder="Ask about homework, attendance, or performance..."
              maxLength={500}
              disabled={isLoading}
