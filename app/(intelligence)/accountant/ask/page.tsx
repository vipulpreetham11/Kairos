...
import { askAccountantAI } from './actions'
...
const SUGGESTIONS = [
  ...
  'How many students have fees overdue more than 60 days?',
  'What is the total collection this month?',
  'Which fee head has the lowest collection rate?',
  'How many invoices are unpaid this term?',
  'What is the 90+ days overdue total amount?',
]
...
export default function AccountantAskPage() {
  ...
  async function handleSubmit(question: string) {
    ...
    const response = await askAccountantAI(trimmed, conversationHistory)
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex-shrink-0">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Ask anything about fee collection
          </p>
        </div>
      </div>
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full px-4 py-12">
            ...
            <p className="text-sm text-slate-500 max-w-sm text-center">
              Ask about outstanding fees, overdue invoices, collection rates, or any fee-related metric.
            </p>
        ...
        <div className="flex gap-3 items-end">
          <div className="flex-1">
            <textarea
              ...
              placeholder="Ask about invoices, collections, defaulters..."
              maxLength={500}
              disabled={isLoading}
