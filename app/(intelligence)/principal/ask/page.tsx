...
const SUGGESTIONS = [
  ...
  'Which section has the worst attendance this week?',
  'How many students failed in the last exam?',
  'What is the fee collection rate this term?',
...
export default function PrincipalAskPage() {
  ...
  async function handleSubmit(question: string) {
    ...
    const response = await askAI(trimmed, conversationHistory)
        ...
        {messages.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full px-4 py-12">
            ...
            <p className="text-sm text-slate-500 max-w-sm text-center">
              Ask about attendance, fees, student performance, exam results, or anything about your school.
            </p>
