...
import { askTeacherAI } from './actions'
...
export default function TeacherAskPage() {
  ...
  async function handleSubmit(question: string) {
    ...
    const response = await askTeacherAI(trimmed, conversationHistory)
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex-shrink-0">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Ask About My Classes</h1>
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full px-4 py-12">
            ...
            <p className="text-sm text-slate-500 max-w-sm text-center">
              Get personalized insights about your students' progress, homework, and attendance instantly.
            </p>
